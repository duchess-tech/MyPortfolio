...
function ProjectHover(props) {
    return (
        <div style={{backgroundColor:props.color}}  className="absolute projectHover  text-center p-2 text-navyblue  w-72 h-52 xl:left-6 xl:top-6 top-0 -left-8  rounded-lg  hidden hover:block ">
